 ...
 * e os liga aos passos do pacote {@code com.testetecnico.tarifaagua.bdd}. Por ter o
 * sufixo {@code IT}, é executado pelo Failsafe em {@code mvn verify}.</p>
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.testetecnico.tarifaagua.bdd")
